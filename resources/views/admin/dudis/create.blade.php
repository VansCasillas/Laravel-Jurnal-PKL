...
<div class="container mt-4">
    ...
    <form action="{{ route('admin.dudi.store') }}" method="POST" class="bg-white p-4 rounded shadow-sm">
        ...
        <div class="mb-3">
            ...
            <input type="text" id="nama_dudi" name="nama_dudi" class="form-control styled-input" value="{{ old('nama_dudi') }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" id="jenis_usaha" name="jenis_usaha" class="form-control styled-input" value="{{ old('jenis_usaha') }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" id="alamat" name="alamat" class="form-control styled-input" value="{{ old('alamat') }}">
            @error('alamat') <small class="text-danger">{{ $message }}</small> @enderror
        </div>
        <div class="mb-3">
            <label for="pimpinan" class="form-label fw-semibold text-dark">Pimpinan</label>
            <input type="text" id="pimpinan" name="pimpinan" class="form-control styled-input" value="{{ old('pimpinan') }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" id="kontak" name="kontak" class="form-control styled-input" value="{{ old('kontak') }}">
