...
<div class="container mt-4">
    ...
    <form action="{{ route('admin.dudi.update', $dudi->id) }}" method="POST" class="bg-white p-4 rounded shadow-sm">
        ...
        <div class="mb-3">
            ...
            <input type="text" id="nama_dudi" name="nama_dudi" value="{{ $dudi->nama_dudi }}" class="form-control styled-input" required>
        ...
        <div class="mb-3">
            ...
            <input type="text" id="jenis_usaha" name="jenis_usaha" value="{{ $dudi->jenis_usaha }}" class="form-control styled-input" required>
        ...
        <div class="mb-3">
            ...
            <input type="text" id="alamat" name="alamat" value="{{ $dudi->alamat }}" class="form-control styled-input" required>
            @error('alamat') <small class="text-danger">{{ $message }}</small> @enderror
        </div>
        <div class="mb-3">
            <label for="pimpinan" class="form-label fw-semibold text-dark">Pimpinan</label>
            <input type="text" id="pimpinan" name="pimpinan" value="{{ $dudi->pimpinan }}" class="form-control styled-input" required>
        ...
        <div class="mb-3">
            ...
            <input type="text" id="pembimbing" name="pembimbing" value="{{ $dudi->pembimbing }}" class="form-control styled-input" required>
        ...
        <div class="mb-3">
            ...
            <input type="text" id="kontak" name="kontak" value="{{ $dudi->kontak }}" class="form-control styled-input" required>
